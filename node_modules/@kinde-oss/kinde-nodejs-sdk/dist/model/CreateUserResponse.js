...
var _UserIdentity = _interopRequireDefault(require("./UserIdentity"));
...
var CreateUserResponse = /*#__PURE__*/function () {
   ...
   */
  _createClass(CreateUserResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('identities')) {
          obj['identities'] = _ApiClient["default"].convertToType(data['identities'], [_UserIdentity["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['identities']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _UserIdentity["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = CreateUserResponse;
