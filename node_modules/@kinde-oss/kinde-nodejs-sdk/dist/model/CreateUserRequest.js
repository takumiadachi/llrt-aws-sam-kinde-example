...
var _CreateUserRequestIdentitiesInner = _interopRequireDefault(require("./CreateUserRequestIdentitiesInner"));
var _CreateUserRequestProfile = _interopRequireDefault(require("./CreateUserRequestProfile"));
...
var CreateUserRequest = /*#__PURE__*/function () {
  ...
  _createClass(CreateUserRequest, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('profile')) {
          obj['profile'] = _CreateUserRequestProfile["default"].constructFromObject(data['profile']);
        }
        if (data.hasOwnProperty('identities')) {
          obj['identities'] = _ApiClient["default"].convertToType(data['identities'], [_CreateUserRequestIdentitiesInner["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['profile']) {
        // data not null
        _CreateUserRequestProfile["default"].validateJSON(data['profile']);
      }
      if (data['identities']) {
        // data not null
        ...
        var _iterator = _createForOfIteratorHelper(data['identities']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _CreateUserRequestIdentitiesInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
