...
var _UserProfile = _interopRequireDefault(require("../model/UserProfile"));
var _UserProfileV = _interopRequireDefault(require("../model/UserProfileV2"));
  ...
  */
  ...
  _createClass(OAuthApi, [{
    ...
    value: function getUser(callback) {
      ...
      var returnType = _UserProfile["default"];
      return this.apiClient.callApi('/oauth2/user_profile', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
    ...
    key: "getUserProfileV2",
    value: function getUserProfileV2(callback) {
      var postBody = null;
      var pathParams = {};
      var queryParams = {};
      var headerParams = {};
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _UserProfileV["default"];
      return this.apiClient.callApi('/oauth2/v2/user_profile', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
    }
  }]);
  return OAuthApi;
}();
