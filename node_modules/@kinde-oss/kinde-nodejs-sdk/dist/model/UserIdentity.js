...
var _UserIdentityResult = _interopRequireDefault(require("./UserIdentityResult"));
...
var UserIdentity = /*#__PURE__*/function () {
   ...
   */
  _createClass(UserIdentity, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('result')) {
          obj['result'] = _UserIdentityResult["default"].constructFromObject(data['result']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['result']) {
        // data not null
        _UserIdentityResult["default"].validateJSON(data['result']);
      }
      return true;
    }
  }]);
