 ...
 * @version 1
 */
var GetOrganizationsUsersResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetOrganizationsUsersResponse</code>.
   * @alias module:model/GetOrganizationsUsersResponse
   */
  function GetOrganizationsUsersResponse() {
    _classCallCheck(this, GetOrganizationsUsersResponse);
   ...
   */
  _createClass(GetOrganizationsUsersResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('organization_users')) {
          obj['organization_users'] = _ApiClient["default"].convertToType(data['organization_users'], [_OrganizationUser["default"]]);
        }
    ...
    value: function validateJSON(data) {
      ...
      if (data['organization_users']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['organization_users']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _OrganizationUser["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = GetOrganizationsUsersResponse;
