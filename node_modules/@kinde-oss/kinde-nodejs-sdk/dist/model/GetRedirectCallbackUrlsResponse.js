...
var _RedirectCallbackUrls = _interopRequireDefault(require("./RedirectCallbackUrls"));
 ...
 * @version 1
 */
var GetRedirectCallbackUrlsResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetRedirectCallbackUrlsResponse</code>.
   * @alias module:model/GetRedirectCallbackUrlsResponse
   */
  function GetRedirectCallbackUrlsResponse() {
    _classCallCheck(this, GetRedirectCallbackUrlsResponse);
   ...
   */
  _createClass(GetRedirectCallbackUrlsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('redirect_urls')) {
          obj['redirect_urls'] = _ApiClient["default"].convertToType(data['redirect_urls'], [_RedirectCallbackUrls["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      if (data['redirect_urls']) {
        ...
        var _iterator = _createForOfIteratorHelper(data['redirect_urls']),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var item = _step.value;
            _RedirectCallbackUrls["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var _default = GetRedirectCallbackUrlsResponse;
